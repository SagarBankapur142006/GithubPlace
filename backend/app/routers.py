...
async def create_listing(
    ...
    listing = Listing(
        ...
        category=body.pitch_deck.get("category", "Software"),
        tech_stack=body.pitch_deck.get("tech_stack", []),
        complexity=body.pitch_deck.get("complexity", "Intermediate"),
        revenue_model=body.pitch_deck.get("revenue_model", "One-time"),
        growth_potential_score=int(body.pitch_deck.get("growth_potential_score", 85)),
